...
%windir%\microsoft.net\framework\v4.0.30319\msbuild "Plugins\Teniprimgaku\Teniprimgaku.sln" /v:minimal /p:Configuration=%conf%;TarjetFrameworkVersion=v3.5 "/p:Platform=Any CPU" "/p:OutputPath=%CD%\build\Plugins\"
